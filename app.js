...
const cuentos = require('./data/Cuentos.json');
const vista = require('./data/VistaPPAL.json');
const usuarios = require('./data/usuarios.json');
const recomendaciones= require('./data/Recomendaciones.json');
// GET principal
app.get('/', (req, res) => {
...
app.post('/api/recomendaciones', (req, res) => {
    ...
    const nuevaRecomendacion = {
       nombre, mail ,titulo, descripcion
    };

    recomendaciones.push(nuevaRecomendacion);

    fs.writeFileSync("./data/recomendaciones.json", JSON.stringify(recomendaciones, null, 2));
